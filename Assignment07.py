# ------------------------------------------------------------------------------------------ #
# Title: Assignment07
# Desc: This assignment demonstrates using data classes to manage data
# Change Log: (Who, When, What)
#   RRoot,1/1/2030,Created Script
#   Ogonna Anunoby, 09/11/2024, First attempt at Assignment 07
# ------------------------------------------------------------------------------------------ #
...
class FileProcessor:
    ...
    Ogonna Anunoby, 09/23/2024, Created class
    """
    @staticmethod
...
class Person:
    ...
    ChangeLog:
    - Ogonna Anunoby, 09/23/2024, Created the class.
    """
